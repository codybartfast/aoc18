...
(*
    ...
    It got close with 1066 (low) so I tried 1073 (high) in case I had an
    off by 7 error.  At this point, to get some sleep, I just tried all 
    the values in between until I got the right answer (1070).  :'(
*)
module Day22a
